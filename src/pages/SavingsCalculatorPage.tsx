...
} from 'features/savings-calculator/lib/savingsProductsSelectors';
    ...
    <>
      ...
      <Tabs defaultValue="products">
        ...
        <SavingsProductDataBoundary
          select={isSelectionReady(condition) ? selectAvailableProducts(condition) : undefined}
        >
          {availableProducts => (
            <>
              ...
              <Tabs.Panel value="results">
                ...
                <SavingsProductListSection
                  products={selectRecommendedProducts(availableProducts)}
